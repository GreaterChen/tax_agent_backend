...
class Custom_ai_packageModel(BaseModel):
    """
    用户套餐情况表对应pydantic模型
    """
...
class Custom_ai_packageQueryModel(Custom_ai_packageModel):
    """
    用户套餐情况不分页查询模型
    """
    pass
...
@as_query
class Custom_ai_packagePageQueryModel(Custom_ai_packageQueryModel):
    """
    用户套餐情况分页查询模型
    """
...
class DeleteCustom_ai_packageModel(BaseModel):
    """
    删除用户套餐情况模型
    """
